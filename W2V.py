...
def evaluate_analogies(self, analogies_filepath="https://raw.githubusercontent.com/RaRe-Technologies/gensim/develop/gensim/test/test_data/questions-words.txt"):
